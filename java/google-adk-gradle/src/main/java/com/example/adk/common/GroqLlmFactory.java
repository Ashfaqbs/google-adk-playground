...
/**
 * Wires an ADK {@link com.google.adk.models.BaseLlm} to Groq's OpenAI-compatible chat
 * completions endpoint via the LangChain4j adapter, since ADK Java talks to Gemini natively
 * and needs this bridge for any other OpenAI-style provider.
 */
    ...
    public static LangChain4j create(String modelName) {
        ...
        if (apiKey == null || apiKey.isBlank()) {
            throw new IllegalStateException(
                    "GROQ_API_KEY is not set. Copy .env.example to .env in java/google-adk-gradle"
        ...
        // Streaming demos (p5) need a StreamingChatModel too - the adapter throws otherwise.
